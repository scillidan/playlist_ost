...
#let rawContent = read("The Legend of Heroes Zero no Kiseki.mp3.chp")
...
#grid(
  ...
  [
    #block(
      ...
      align(center, box(
        ...
        stroke: 0.15pt + black,
        image(
          "The Legend of Heroes Zero no Kiseki.jpg",
          width: 100%,
          height: 100%,
          fit: "contain",
        ),
  ...
  [
    #block(
      ...
      inset: (x: 1em, y: 1em),
      {
        text(size: 2.3em, weight: "bold", font: (
          "MonaspiceNe NFM",
          "Sarasa Mono SC",
